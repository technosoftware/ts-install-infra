...
cd /tmp
sudo wget https://raw.githubusercontent.com/technsoftware/technosoftware-install-infra/master/wildfly-install.sh
dos2unix /tmp/wildfly-install.sh

chmod 777 /tmp/wildfly-install.sh
sudo /bin/bash /tmp/wildfly-install.sh

wget https://raw.githubusercontent.com/technsoftware/technosoftware-install-infra/master/wildfly-init-debian.sh
